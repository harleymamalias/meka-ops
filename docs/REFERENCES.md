...
Curated references. Each link is here because it's the authoritative or most useful source for something you'll actually encounter in this project.
...
| NestJS — Logger (Pino) | https://docs.nestjs.com/techniques/logger |
...
| PostgreSQL DECIMAL vs FLOAT | https://www.postgresql.org/docs/current/datatype-numeric.html |
...
| Structured Logging Guide | https://betterstack.com/community/guides/logging/nodejs |
...
| Resource | URL |
|---|---|
| NestJS Architecture Overview | https://docs.nestjs.com/modules |

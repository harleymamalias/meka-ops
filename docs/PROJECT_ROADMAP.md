...
2. The backend controllers, DTOs, response envelope, and Swagger document for API contracts.
3. This roadmap for sequencing, decisions, and completion criteria.
